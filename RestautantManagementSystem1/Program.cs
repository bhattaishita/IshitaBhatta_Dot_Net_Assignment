...
builder.Services.AddDefaultIdentity<RestautantManagementSystem1User>(options => options.SignIn.RequireConfirmedAccount = true).AddEntityFrameworkStores<RestautantManagementSystem1Context>();
